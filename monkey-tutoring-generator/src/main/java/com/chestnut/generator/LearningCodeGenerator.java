...
public class LearningCodeGenerator {
	...
	public static void main(String[] args) {
		...
		//生成路径
		gc.setOutputDir(System.getProperty("user.dir") + "/monkey-tutoring-generator/src/main/java");
		gc.setAuthor("Chestnut");
		gc.setOpen(false);
		...
		dsc.setUrl("jdbc:mysql://192.168.101.65:3306/mt_learning"
